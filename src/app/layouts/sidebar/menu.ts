...
export const MENU: MenuItem[] = [
...

    {
        ...
        subItems: [
            ...
            {
                id: 4.7, // Correction de l'id du sous-élément
                label: 'error-pages',
                parentId: 4,
                subItems: [
                    {
                        id: 4.8, // Correction de l'id du sous-sous-élément
                        label: '404-error',
                        link: '/pages-404',
                        parentId: 4.7,
                        roles: [''], // Ajouté
                    ...
                    {
                        id: 4.9, // Correction de l'id du sous-sous-élément
                        label: 'offline',
                        link: '/pages-offline',
                        parentId: 4.7,
                        roles: [''], // Ajouté
            ...
            {
                id: 4.10, // Correction de l'id du sous-élément
                label: 'maintenance',
    ...
    {
        id: 5.1, // Correction de l'id
        label: 'ui-elements',
        icon: "life-buoy",
        subItems: [
            {
                id: 5.2, // Correction de l'id
                label: 'alerts',
                link: '/ui-alerts',
                parentId: 5.1,
                roles: [''], // Ajouté
