...
function toggleHamburgerMenu() {
    ...
    if (document.documentElement.getAttribute("data-layout") === "vertical") {
        if (windowSize <= 1025 && windowSize >= 768) {
            ...
            document.documentElement.getAttribute("data-sidebar-size") == localStorage.getItem("data-sidebar-size") ?
                document.documentElement.setAttribute("data-sidebar-size", localStorage.getItem("data-sidebar-size") == 'sm' ? 'lg' : 'sm') :
                document.documentElement.setAttribute("data-sidebar-size", localStorage.getItem("data-sidebar-size"));
...
function hideShowLayoutOptions(dataLayout) {
    if (dataLayout == "horizontal") {
        ...
        if (document.getElementById("customizerButton")) {
            ...
            document.documentElement.setAttribute("data-sidebar-size", localStorage.getItem("data-sidebar-size"));
            document.documentElement.setAttribute("data-sidebar", localStorage.getItem("data-sidebar"));
        }
    }
}
...
function setDefaultAttribute() {
    if (!localStorage.getItem("defaultAttribute")) {
        ...
        attributesToRetrieve.forEach(function (attribute) {
            isLayoutAttributes[attribute] = localStorage.getItem(attribute);
        });
        layoutSwitch(isLayoutAttributes);
    }
